/*
Package spl provides a complete compiler toolchain for a simple programming
language (SPL). Its (german) specification can be reviewed here:
...
The following small SPL program calculates solutions to the well-known
"Eight Queens Puzzle":
